...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid" id="crop_type_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <label class="control-label"><?php echo $variety['crop_type_name'];?></label>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <label class="control-label"><?php echo $variety['variety_name'];?></label>
            </div>
        </div>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="variety[quantity]" class="form-control float_type_positive" style="text-align: left" value="<?php echo $variety['quantity'];?>"/>
            </div>
        </div>
    </div>
