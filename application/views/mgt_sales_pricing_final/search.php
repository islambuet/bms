...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("click", "#button_action_save_jqx", function(event)
        {
            ...
            {
                $('#save_form_jqx  #jqx_inputs').append('<input type="hidden" name="items['+data[i]['variety_id']+'][tp_final]" value="'+data[i]['tp_final']+'">');
                $('#save_form_jqx  #jqx_inputs').append('<input type="hidden" name="items['+data[i]['variety_id']+'][commission_final]" value="'+data[i]['commission_final']+'">');
                $('#save_form_jqx  #jqx_inputs').append('<input type="hidden" name="items['+data[i]['variety_id']+'][incentive_final]" value="'+data[i]['incentive_final']+'">');
            }
