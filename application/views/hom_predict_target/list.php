<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    {
        $action_data["action_details"]=site_url($CI->controller_url."/index/details/".$year0_id);
    }
...
<div class="row widget">
    ...
    if(isset($CI->permissions['column_headers'])&&($CI->permissions['column_headers']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="status_target_finalize">Target Finalized</label>
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="status_prediction_finalize">Prediction Finalized</label>
        </div>
        <?php
    }
    ?>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Target Finalized', dataField: 'status_target_finalize',filtertype: 'list'},
                    { text: 'Prediction Finalized', dataField: 'status_prediction_finalize',filtertype: 'list'}
