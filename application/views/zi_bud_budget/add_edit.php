<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    {
        $action_data["action_details_get"]=site_url($CI->controller_url."/index/details/".$zone_id.'/'.$year0_id.'/'.$crop_id);
    }
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {
                        columngroup: '<?php echo 'year'.$i.'_id'; ?>',text: 'ZI', dataField: '<?php echo 'year'.$i.'_budget_quantity';?>',align:'center',width:'110',cellsrenderer: cellsrenderer,cellsAlign:'right',columntype:'custom',
                ...
                columngroups:
                    [
                        { text: 'Territories', align: 'center', name: 'area' },
