...
<div class="row widget">
    ...
    if(isset($CI->permissions['column_headers'])&&($CI->permissions['column_headers']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="name">Fiscal Year</label>
                <?php
                foreach($months as $month)
                {
                    ?>
                    <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="quantity_<?php echo $month;?>"><?php echo date("M", mktime(0, 0, 0,$month,1, 2000));?></label>
                <?php
                }
                ?>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="total">Total</label>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo base_url($CI->controller_url.'/index/get_items_year');?>";
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                <?php
                    foreach($months as $month)
                    {
                        ?>{ name: 'quantity_<?php echo $month;?>', type: 'string' },
                        <?php
                    }
                ?>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                rowsheight: 35,
                columns: [
                    { text: 'Fiscal Year', dataField: 'name',width: '130',cellsrenderer: cellsrenderer,pinned:true,rendered: tooltiprenderer},
                    <?php
                        foreach($months as $month)
                        {
