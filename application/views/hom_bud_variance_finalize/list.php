...
<div class="row widget">
    ...
    if(isset($CI->permissions['column_headers'])&&($CI->permissions['column_headers']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="status_variance_finalize">Variance Finalized</label>
        </div>
        <?php
    }
    ?>
    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'status_variance_finalize', type: 'string' }
            ],
            id: 'id',
            url: url
        };
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Variance Finalized', dataField: 'status_variance_finalize'}
