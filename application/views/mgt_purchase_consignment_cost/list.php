        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_MONTH_PURCHASE'); ?>', dataField: 'month'},
                    { text: '<?php echo $CI->lang->line('LABEL_DATE_PURCHASE'); ?>', dataField: 'date_purchase',cellsalign: 'right'}
                ]
            });
    });
</script>