...
<div class="row widget">
    ...
    if(isset($CI->permissions['column_headers'])&&($CI->permissions['column_headers']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            ...
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="num_total_customers">Number of Customers in Territory</label>
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="num_budgeted_customers">Number of Customers Budgeted</label>
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="num_varieties_customer">#Varieties Budgeted by Customers'</label>
            <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="num_varieties_customer">#Varieties Budgeted by TI</label>
        </div>
        <?php
    }
    ?>
    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'num_total_customers', type: 'string' },
                { name: 'num_budgeted_customers', type: 'string' },
                { name: 'num_varieties_customer', type: 'string' },
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_TERRITORY_NAME'); ?>', dataField: 'territory_name',width:'150',align:'center'},
                    { text: '<?php echo $CI->lang->line('LABEL_FORWARDED'); ?>', dataField: 'status_forward',width:'150',filtertype: 'list',align:'center'},
                    { text: 'Number of<br>Customers<br>in Territory', dataField: 'num_total_customers',width:'80',cellsAlign:'right',align:'center'},
                    { text: 'Number of <br>Customers<br>Budgeted', dataField: 'num_budgeted_customers',width:'80',cellsAlign:'right',align:'center'},
                    { text: '#Varieties<br> Budgeted by<br>Customers', dataField: 'num_varieties_customer',width:'100',cellsAlign:'right',align:'center'},
                    { text: '#Varieties<br> Budgeted by<br>TI', dataField: 'num_varieties_ti',width:'100',cellsAlign:'right',align:'center'}
