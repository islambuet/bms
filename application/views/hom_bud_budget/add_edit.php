        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {
                        columngroup: '<?php echo 'year'.$i.'_id'; ?>',text: 'HOM', dataField: '<?php echo 'year'.$i.'_budget_quantity';?>',align:'center',width:'110',cellsrenderer: cellsrenderer,cellsAlign:'right',columntype:'custom',
