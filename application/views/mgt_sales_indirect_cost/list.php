        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                autoheight: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_FISCAL_YEAR'); ?>', dataField: 'name',width:'100'},
                    { text: 'Setup Done', dataField: 'setup_status',width:'250',cellsalign: 'right',filtertype:'list'}
                ]
            });
    });
</script>