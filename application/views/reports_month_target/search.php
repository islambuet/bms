    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            <div class="col-xs-6">
                ...
                <div class="row show-grid">
                    <div class="col-xs-6">
                        <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_MONTH_START');?></label>
                    </div>
                    <div class="col-xs-6">
                        <select id="month_start" class="form-control" name="report[month_start]">
                            <option value=""><?php echo $this->lang->line('SELECT');?></option>
                            <?php
                            for($i=1;$i<13;$i++)
                            {?>
                ...
                <div class="row show-grid">
                    <div class="col-xs-6">
                        <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_MONTH_END');?></label>
                    </div>
                    <div class="col-xs-6">
                        <select id="month_end" class="form-control" name="report[month_end]">
                            <option value=""><?php echo $this->lang->line('SELECT');?></option>
                            <?php
                            for($i=1;$i<13;$i++)
                            {?>
