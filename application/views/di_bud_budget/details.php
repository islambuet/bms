        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    {
                        columngroup: '<?php echo 'year'.$i.'_id'; ?>',text: 'DI', dataField: '<?php echo 'year'.$i.'_budget_quantity';?>',align:'center',width:'80',cellsrenderer: cellsrenderer,cellsAlign:'right',columntype:'custom'},
                    <?php
                        }
                    ?>
