<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    {
        $action_data["action_edit"]=site_url($CI->controller_url."/index/edit/".$division_id.'/'.$year0_id);
    }
    if(isset($CI->permissions['view'])&&($CI->permissions['view']==1))
    {
        $action_data["action_details"]=site_url($CI->controller_url."/index/details/".$division_id.'/'.$year0_id);
    }
...
<script type="text/javascript">
    ...
    {
        var url = "<?php echo site_url($CI->controller_url."/index/get_items/".$division_id.'/'.$year0_id);?>";
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_FORWARDED'); ?>', dataField: 'status_forward'}
