            ...
            if($this->locations['division_id']>0)
            {
                ...
                if($this->locations['zone_id']>0)
                {
                    ...
                    if($this->locations['territory_id']>0)
                    {
                        ...
                        {
                            $data['customers']=Query_helper::get_info($this->config->item('tems_csetup_customers'),array('id value','name text'),array('district_id ='.$this->locations['district_id'],'status ="'.$this->config->item('system_status_active').'"'));
                        }
                    }
                }
            }
